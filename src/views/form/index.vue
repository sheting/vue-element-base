...
export default class BaseFormComponent extends Vue {
  ...
  handleRemove (file: object, fileList: object[]) {
    this.fileList = fileList
  }
  handleSuccess (response: object, file: object, fileList: object[]) {
    console.log('response----', response)
  }
  handleError (err: object, file: object, fileList: object[]) {
    console.log('error----', err)
  }
  handleChange (file: object, fileList: object[]) {
    this.fileList = fileList
  }
